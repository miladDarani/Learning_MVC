...
class SeedGamesTable extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::table('games')->insert([
            ...
            'featured_image' => 'mario1-small.jpg',
            'rating' => 'everyone',
            'year' => 2011,
            'category_id' => 2
        ...
        DB::table('games')->insert([
            ...
            'featured_image' => 'mario2-small.jpg',
            'rating' => 'everyone',
            'year' => 2017,
            'category_id' => 2
