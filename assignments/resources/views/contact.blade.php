      ...
      <div class="row d-flex justify-content-center">
        ...
        <div class="col-md-6">
          ...
          <form class="text-center" action="#!">
            ...
            <p class="h4 mb-4" style="color:white;">Sign up</p>
            ...
            <div class="custom-control custom-checkbox">
              ...
              <label class="custom-control-label" for="defaultRegisterFormNewsletter" style="color:white;">Subscribe to our
                newsletter</label>
            </div>
            ...
            <p style="color:white">By clicking
              <em style="color:white">Sign up</em> you agree to our
